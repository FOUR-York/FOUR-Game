...
set CLASSPATH=%APP_HOME%\lib\FOUR-Game-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" io.github.FOUR.game.lwjgl3.Lwjgl3Launcher %*
